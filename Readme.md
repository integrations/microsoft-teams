...
|Write access to issues, actions and pull requests | To take action from Teams by clicking a button on a card. e.g. create an issue, re-run jobs in a workflow and comment on a pull request|
